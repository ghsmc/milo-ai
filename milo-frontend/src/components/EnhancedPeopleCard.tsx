        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="w-6 h-6 rounded flex items-center justify-center flex-shrink-0">
              <img 
                src={`https://img.logo.dev/${alumni.current_company.toLowerCase().replace(/\s+/g, '')}.com?token=pk_c2nKhfMyRIOeCjrk-6-RRw`}
                alt={`${alumni.current_company} logo`}
              ...
              />
              <div 
                className="w-6 h-6 rounded bg-gray-600 text-white text-xs font-bold flex items-center justify-center hidden"
                style={{ display: 'none' }}
              >
